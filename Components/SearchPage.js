...
import { CommonActions, useNavigationState, useIsFocused } 	from '@react-navigation/native'
...
const SearchPage = ({navigation, route}) => {
	...
	if(state.routes[1] != undefined && state.routes[1].name == 'Поиск' && state.routes[2] == undefined && isFocused == false){
